...
console.log('🔍 PROBANDO RUTAS SIN PREFIJO GLOBAL');
console.log('=====================================\n');
...
async function testRoutes() {
  ...
  console.log('🔄 Probando rutas sin prefijo...\n');
  ...
  console.log('\n📝 PARA EL FRONTEND:');
  console.log('===================');
  console.log('URL Base: https://nuevolienzoback.onrender.com');
  console.log('Swagger: https://nuevolienzoback.onrender.com/docs');
  console.log('Ejemplos:');
  console.log('- Productos: https://nuevolienzoback.onrender.com/products');
  console.log('- Categorías: https://nuevolienzoback.onrender.com/categories');
  console.log('- Ingredientes: https://nuevolienzoback.onrender.com/ingredients');
}
