...
export class GetProductsFilterDto {
  ...
  @ApiPropertyOptional({ example: '123e4567-e89b-12d3-a456-426614174000', description: 'ID de la categoría para filtro' })
  @IsOptional()
  @IsUUID()
  categoryId?: string;
  ...
  @ApiPropertyOptional({ example: 'asc', description: 'Dirección de la ordenación', enum: ['asc', 'desc'] })
  @IsOptional()
  @IsString()
  @IsIn(['asc', 'desc'])
  order?: 'asc' | 'desc';
